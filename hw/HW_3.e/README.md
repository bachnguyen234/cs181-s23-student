# CS-181/DA-210 Homework 3.e

The goal of this HW is to help you practice working with declarative XML operations using XPath.

**Note that you may complete this homework with one partner.  You must type up all of the code yourself, but you can work together and look at each other's code.  You _must_ include the name of your partner, if any, in the cell at the end of xpath.ipynb.**

---

## Step 1: Working with XPath

Complete [`xpath.ipynb`](xpath.ipynb).  This notebook contains exercises using XPath to work with an XML dataset.
