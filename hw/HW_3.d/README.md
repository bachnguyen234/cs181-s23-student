# CS-181/DA-210 Homework 3.d

The goal of this HW is to help you practice working with regular expressions.

**Note that you may complete this homework with one partner.  You must type up all of the code yourself, but you can work together and look at each other's code.  You _must_ include the name of your partner, if any, in the cell at the end of regex.ipynb.**

---

## Step 1: Regular expressions

Complete [`regex.ipynb`](regex.ipynb).  This notebook contains exercises using the `re` module to work with regular expressions.
